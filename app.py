...
<style>
    ...
    /* Ocultar botões de download dos dataframes */
...
st.warning("""
⚠️ **Proteção de Dados:** Os dados desta plataforma são protegidos por direitos autorais. 
A extração, download em massa ou reprodução não autorizada dos dados é estritamente proibida. 
Este sistema é apenas para consulta individual e fins informativos.
""")
...
<a href="#passo-1-verifique-se-sua-institui-o-elegivel" class="nav-button">
    🏛️ Verificar Instituição
</a>

<a href="#passo-2-buscar-o-peri-dico" class="nav-button nav-button-blue">
    📚 Buscar Periódico
</a>
""", unsafe_allow_html=True)
...
<div style="background-color: #fef3c7; 
    ...
    <p style="margin: 0; color: #92400e; font-size: 0.85rem; line-height: 1.5;">
        ...
        Links para outros sistemas e recursos do Grupo GOBIOTA
    </p>
</div>
""", unsafe_allow_html=True)
...
st.sidebar.markdown("""
<div style="opacity: 0.5; font-size: 0.85rem; color: #6b7280;">
    🔬 Sistemas de Análise<br>
    📊 Banco de Dados<br>
    📚 Publicações<br>
    👥 Equipe<br>
    📧 Contato
