...
with st.expander("🏛️ **PASSO 1:** Verifique se sua Instituição é Elegível", expanded=False):
    st.markdown("""
...
st.markdown("""
<div class="info-box">
    <h3 style="margin-top: 0;">📚 PASSO 2: Buscar o Periódico</h3>
    <p style="margin-bottom: 0;">
        Agora que você verificou sua instituição, busque o periódico específico onde deseja publicar. 
        Se ele estiver listado em uma editora onde sua instituição é elegível → 
