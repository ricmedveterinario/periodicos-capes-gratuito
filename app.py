...
<style>
    ...
    /* ==================== OCULTAR TOOLBAR DO STREAMLIT ==================== */
    
    /* Ocultar toolbar completo (contém botão fullscreen, settings, etc) */
    ...
    /* Ocultar menu hambúrguer (três pontinhos) */
    #MainMenu,
    ...
    /* Ocultar botões específicos de header */
    button[kind="header"],
