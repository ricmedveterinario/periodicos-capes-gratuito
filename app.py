...
def load_data():
    ...
    # Fonte: https://docs.google.com/spreadsheets/d/10Q3uNZARR3eJFr4XsZOF5FvytUBKCnWX
    file_path = "https://docs.google.com/spreadsheets/d/10Q3uNZARR3eJFr4XsZOF5FvytUBKCnWX/export?format=xlsx"
