...
def load_institutions_data():
    ...
    spreadsheet_id = "1MHfosX6bkAoQt34V5Bg2PUykA7hdi1hVv6YbyKLN30E"
...
try:
    ...
    st.markdown("""
<div style="background-color: #f8f9fa; padding: 2rem; border-radius: 10px; border-left: 4px solid #6c757d; margin-top: 2rem;">
    ...
    <div style="margin-bottom: 1.5rem;">
        ...
        <p style="margin: 0; font-size: 0.9rem; color: #6c757d;">
            ...
            Todos os direitos sobre o código e interface são reservados.<br>
            Licenciado sob <a href="https://github.com/ricmedveterinario/periodicos-capes-gratuito/blob/main/LICENSE" target="_blank" style="color: #0066cc;">Licença MIT</a>.
        </p>
    </div>
    ...
    <div style="margin-bottom: 1.5rem;">
        ...
        <p style="margin: 0; font-size: 0.9rem; color: #6c757d;">
            Informações baseadas em documentos oficiais do <a href="https://www.periodicos.capes.gov.br" target="_blank" style="color: #0066cc;">Portal CAPES</a> e das editoras participantes.
        </p>
    </div>
    ...
    <div style="margin-bottom: 1.5rem;">
        ...
        <p style="margin: 0; font-size: 0.9rem; color: #6c757d;">
            <strong>Ferramenta independente sem vínculo oficial com CAPES ou editoras.</strong><br>
            Desenvolvida para fins informativos e acadêmicos. Verifique sempre documentos oficiais antes de decisões.<br>
    ...
    <div>
        ...
        <p style="margin: 0; font-size: 0.9rem; color: #6c757d;">
            Esta aplicação <strong>não coleta, armazena ou compartilha dados pessoais</strong>.<br>
...
""", unsafe_allow_html=True)
    ...
    # Rodapé com créditos
    st.markdown("""
<div style="text-align: center; color: #6b7280; padding: 1.5rem; margin-top: 1rem; border-top: 1px solid #e5e7eb;">
    <p style="margin-bottom: 0.5rem; font-size: 0.9rem;">
