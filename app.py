...
try:
    ...
    <div style="background-color: #f8f9fa; 
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <p style="margin: 0; font-size: 0.9rem; color: #6c757d;">
                Informações baseadas em documentos oficiais do 
                <a href="https://www.periodicos.capes.gov.br" target="_blank" style="color: #0066cc;">Portal CAPES</a> 
                e das editoras participantes.
            </p>
        </div>
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <p style="margin: 0; font-size: 0.9rem; color: #6c757d;">
                ...
                Desenvolvida para fins informativos e acadêmicos. 
                Verifique sempre documentos oficiais antes de decisões.<br>
